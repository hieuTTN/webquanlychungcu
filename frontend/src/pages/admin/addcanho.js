                    ...
                    <div class="form-add">
                        <form class="row" onSubmit={saveData} method='post'>
                            <div class="col-md-4 col-sm-12 col-12">
                                ...
                                <input defaultValue={item?.acreage} type='number' name="acreage" class="form-control"/>
                                <label class="lb-form">Tầng</label>
                                <input defaultValue={item?.floor} type='number' min={1} name="floor" class="form-control"/>
                                <label class="lb-form">Giá bán</label>
                                <input defaultValue={item?.price} type='number' min={1} name="price" class="form-control"/>
